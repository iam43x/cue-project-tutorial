...
#Server: {
	...
	tls?: #ServerTLSSettings @protobuf(3,ServerTLSSettings)
...
#ServerTLSSettings: {
	...
	caCrl?: string @protobuf(13,string,name=ca_crl)
	...
	verifyCertificateSpki?: [...string] @protobuf(11,string,name=verify_certificate_spki)
	...
	// are specified, a hash matching either value will result in the
	// certificate being accepted.
	verifyCertificateHash?: [...string] @protobuf(12,string,name=verify_certificate_hash)
