...
import (
	...
	v1alpha1_1 "istio.io/api/analysis/v1alpha1"
)
...
#ServiceEntry: {
	...
	addresses?: [...string] @protobuf(2,string)

	// The ports associated with the external service. If the
	// Endpoints are Unix domain socket addresses, there must be exactly one
	// port.
	ports?: [...#ServicePort] @protobuf(3,ServicePort)
	...
	// or part of the mesh.
	location?: #Location @protobuf(4,Location)
	...
	resolution?: #Resolution @protobuf(5,Resolution)
	...
	endpoints?: [...#WorkloadEntry] @protobuf(6,WorkloadEntry)
	...
	// the ServiceEntry.
	workloadSelector?: #WorkloadSelector @protobuf(9,WorkloadSelector,name=workload_selector)
	...
	// of namespace names.
	exportTo?: [...string] @protobuf(7,string,name=export_to)
	...
	// verified.
	subjectAltNames?: [...string] @protobuf(8,string,name=subject_alt_names)
}
...
#ServicePort: {
	...
	targetPort?: uint32 @protobuf(4,uint32,name=target_port)
}
...
#ServiceEntryStatus: {
	...
	// +patchMergeKey=type
	// +patchStrategy=merge
	conditions?: [...v1alpha1.#IstioCondition] @protobuf(1,meta.v1alpha1.IstioCondition)

	// Includes any errors or warnings detected by Istio's analyzers.
	// +optional
	// +patchMergeKey=type
	// +patchStrategy=merge
	validationMessages?: [...v1alpha1_1.#AnalysisMessageBase] @protobuf(2,analysis.v1alpha1.AnalysisMessageBase,name=validation_messages)
	...
	// +optional
	addresses?: [...#ServiceEntryAddress] @protobuf(10,ServiceEntryAddress)
}
