...
#EnvoyFilter: {
	...
	#ProxyMatch: {
		...
		proxyVersion?: string @protobuf(1,string,name=proxy_version)
	...
	#ClusterMatch: {
		...
		portNumber?: uint32 @protobuf(1,uint32,name=port_number)
		...
		subset?: string @protobuf(3,string)
	...
	#RouteConfigurationMatch: {
		...
		#RouteMatch: {
			...
			action?: #Action @protobuf(2,Action)
		}
		...
		#VirtualHostMatch: {
			...
			route?: #RouteMatch @protobuf(2,RouteMatch)
		}
		...
		portName?: string @protobuf(2,string,name=port_name)
	...
	#ListenerMatch: {
		...
		#FilterChainMatch: {
			...
			transportProtocol?: string @protobuf(3,string,name=transport_protocol)
			...
			applicationProtocols?: string @protobuf(4,string,name=application_protocols)
			...
			filter?: #FilterMatch @protobuf(5,FilterMatch)
			...
			destinationPort?: uint32 @protobuf(6,uint32,name=destination_port)
		}
		...
		#FilterMatch: {
			...
			// Thrift filters.
			subFilter?: #SubFilterMatch @protobuf(2,SubFilterMatch,name=sub_filter)
		}
		...
		// listener.
		filterChain?: #FilterChainMatch @protobuf(3,FilterChainMatch,name=filter_chain)

		// Match a specific listener filter. If specified, the
		// patch will be applied to the listener filter.
		listenerFilter?: string @protobuf(5,string,name=listener_filter)
	...
	#Patch: {
		...
		value?: {} @protobuf(2,google.protobuf.Struct)
		...
		filterClass?: #FilterClass @protobuf(3,FilterClass,name=filter_class)
	}
	...
	#EnvoyConfigObjectMatch: {
		...
		context?: #PatchContext @protobuf(1,PatchContext)

		// Match on properties associated with a proxy.
		proxy?: #ProxyMatch @protobuf(2,ProxyMatch)
		{} | {
			// Match on envoy listener attributes.
			listener: #ListenerMatch @protobuf(3,ListenerMatch)
		} | {
			// Match on envoy HTTP route configuration attributes.
			routeConfiguration: #RouteConfigurationMatch @protobuf(4,RouteConfigurationMatch,name=route_configuration)
		} | {
			// Match on envoy cluster attributes.
			cluster: #ClusterMatch @protobuf(5,ClusterMatch)
		}
	}
	...
	#EnvoyConfigObjectPatch: {
		...
		applyTo?: #ApplyTo @protobuf(1,ApplyTo,name=apply_to)

		// Match on listener/route configuration/cluster.
		match?: #EnvoyConfigObjectMatch @protobuf(2,EnvoyConfigObjectMatch)

		// The patch to apply along with the operation.
		patch?: #Patch @protobuf(3,Patch)
	}
	...
	workloadSelector?: #WorkloadSelector @protobuf(3,WorkloadSelector,name=workload_selector)
	...
	configPatches?: [...#EnvoyConfigObjectPatch] @protobuf(4,EnvoyConfigObjectPatch,name=config_patches)
