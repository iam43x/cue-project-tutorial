...
#AnalysisMessageBase: {
	...
	level?: #Level @protobuf(2,Level)

	// A url pointing to the Istio documentation for this specific error type.
	// Should be of the form
	// `^http(s)?://(preliminary\.)?istio.io/docs/reference/config/analysis/`
	// Required.
	documentationUrl?: string @protobuf(3,string,name=documentation_url)
}
...
#AnalysisMessageWeakSchema: {
	// Required
	messageBase?: #AnalysisMessageBase @protobuf(1,AnalysisMessageBase,name=message_base)
	...
	// Required.
	template?: string @protobuf(3,string)
	...
	#ArgType: {
		...
		// go_type for now.
		goType?: string @protobuf(2,string,name=go_type)
	}

	// A description of the arguments for a particular message type
	args?: [...#ArgType] @protobuf(4,ArgType)
}
...
#GenericAnalysisMessage: {
	...
	args?: {} @protobuf(2,google.protobuf.Struct)
	...
	resourcePaths?: [...string] @protobuf(3,string,name=resource_paths)
}
