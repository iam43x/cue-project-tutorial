...
#RequestAuthentication: {
	...
	// $hide_from_docs
	targetRef?: v1beta1.#PolicyTargetReference @protobuf(3,istio.type.v1beta1.PolicyTargetReference)
	...
	targetRefs?: [...v1beta1.#PolicyTargetReference] @protobuf(4,istio.type.v1beta1.PolicyTargetReference)
	...
	jwtRules?: [...#JWTRule] @protobuf(2,JWTRule,name=jwt_rules)
}
...
#JWTRule: {
	...
	issuer: string @protobuf(1,string)
	...
	audiences?: [...string] @protobuf(2,string)
	...
	jwksUri?: string @protobuf(3,string,name=jwks_uri)

	// JSON Web Key Set of public keys to validate signature of the JWT.
	// See https://auth0.com/docs/jwks.
	//
	// Note: Only one of `jwksUri` and `jwks` should be used.
	jwks?: string @protobuf(10,string)
	...
	// Note: Requests with multiple tokens (at different locations) are not supported, the output principal of
	// such requests is undefined.
	fromHeaders?: [...#JWTHeader] @protobuf(6,JWTHeader,name=from_headers)
	...
	// such requests is undefined.
	// +kubebuilder:list-value-validation:MinLength=1
	fromParams?: [...string] @protobuf(7,string,name=from_params)
	...
	outputPayloadToHeader?: string @protobuf(8,string,name=output_payload_to_header)
	...
	// such requests is undefined.
	// +kubebuilder:list-value-validation:MinLength=1
	fromCookies?: [...string] @protobuf(12,string,name=from_cookies)

	// If set to true, the original token will be kept for the upstream request. Default is false.
	forwardOriginalToken?: bool @protobuf(9,bool,name=forward_original_token)
	...
	outputClaimToHeaders?: [...#ClaimToHeader] @protobuf(11,ClaimToHeader,name=output_claim_to_headers) // [TODO:Update the status whenever this feature is promoted.]
	...
	timeout?: time.Duration @protobuf(13,google.protobuf.Duration)
	// $hide_from_docs
...
#ClaimToHeader: {
	...
	header: string @protobuf(1,string)
	...
	// +kubebuilder:validation:MinLength=1
	claim: string @protobuf(2,string)
}
